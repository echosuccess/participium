...
function createReport(data) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const newReport = yield index_1.prisma.report.create({
            data: {
                title: data.title,
...
function getApprovedReports() {
    return __awaiter(this, void 0, void 0, function* () {
        return index_1.prisma.report.findMany({
            where: {
                status: {
                    in: [client_1.ReportStatus.ASSIGNED, client_1.ReportStatus.IN_PROGRESS, client_1.ReportStatus.RESOLVED]
                }
            },
            include: {
                user: {
