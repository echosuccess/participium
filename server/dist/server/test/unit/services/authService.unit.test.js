...
describe("authService", () => {
    ...
    describe("authenticate", () => {
        ...
        it("should reject with UnauthorizedError if no user", () => __awaiter(void 0, void 0, void 0, function* () {
            const mockAuthenticate = jest.fn((strategy, callback) => {
                callback(null, false);
                return (req) => { };
            });
            mockPassport.authenticate = mockAuthenticate;
            yield expect((0, authService_1.authenticate)(mockReq)).rejects.toThrow(utils_1.UnauthorizedError);
        }));
    });
    describe("getSession", () => {
