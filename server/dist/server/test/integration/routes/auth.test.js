...
describe('Authentication Routes', () => {
    ...
    describe('POST /api/session - Login', () => {
        ...
        describe('Failure scenarios - Invalid credentials', () => {
            it('should return 401 with wrong password', () => __awaiter(void 0, void 0, void 0, function* () {
                // Arrange
                const userData = (0, testUtils_1.createTestUserData)();
                yield (0, supertest_1.default)(app).post('/api/citizen/signup').send(userData);
                // Act
            ...
            it('should return 401 with non-existent email', () => __awaiter(void 0, void 0, void 0, function* () {
                // Act
                const response = yield (0, supertest_1.default)(app)
                    .post('/api/session')
                    .send({
    ...
    describe('DELETE /api/session/current - Logout', () => {
        ...
        describe('Failure scenarios', () => {
            it('should return 400 when not logged in', () => __awaiter(void 0, void 0, void 0, function* () {
                // Act
                const response = yield (0, supertest_1.default)(app)
                    .delete('/api/session/current')
                    .expect(400);
